...
def meter_check(meter, screen_load):
  ...
  rl_empty_min, rl_empty_max = rl_empty - configs.main_range, rl_empty + configs.main_range
  gl_empty_min, gl_empty_max = gl_empty - configs.main_range, gl_empty + configs.main_range
  bl_empty_min, bl_empty_max = bl_empty - configs.main_range, bl_empty + configs.main_range
  if rl_empty_min <= rl <= rl_empty_max and gl_empty_min <= gl <= gl_empty_max and bl_empty_min <= bl <= bl_empty_max:
    meter.need = False
  else:
    meter.need = True

  if configs.debug_enable and configs.debug_life_enable:
...
def flask_check(flask, screen_load):
  if flask.enable:
    ...
    r1_empty_min, r1_empty_max = r1_empty - configs.main_range, r1_empty + configs.main_range
    g1_empty_min, g1_empty_max = g1_empty - configs.main_range, g1_empty + configs.main_range
    b1_empty_min, b1_empty_max = b1_empty - configs.main_range, b1_empty + configs.main_range
    if r1_empty_min <= r1 <= r1_empty_max and g1_empty_min <= g1 <= g1_empty_max and b1_empty_min <= b1 <= b1_empty_max:
      flask.valid = False
    else:
      flask.valid = True

  if configs.debug_enable and configs.debug_flask_enable and flask.enable:
...
def menu_check(menu, screen_load, menu_inside):
  ...
  r2_empty_min, r2_empty_max = r2_empty - configs.main_range, r2_empty + configs.main_range
  g2_empty_min, g2_empty_max = g2_empty - configs.main_range, g2_empty + configs.main_range
  b2_empty_min, b2_empty_max = b2_empty - configs.main_range, b2_empty + configs.main_range
  ...
  r3_empty_min, r3_empty_max = r3_empty - configs.main_range, r3_empty + configs.main_range
  g3_empty_min, g3_empty_max = g3_empty - configs.main_range, g3_empty + configs.main_range
  b3_empty_min, b3_empty_max = b3_empty - configs.main_range, b3_empty + configs.main_range
  ...
  if configs.debug_enable and configs.debug_menu_enable:
